...
import com.dev.baseproject.databinding.BottomSheetAlertSoundDetailBinding
...
class EnableOneMethodBottomSheet(): BottomSheetDialogFragment() {

    private lateinit var dataBinding: BottomSheetAlertSoundDetailBinding
    ...
    override fun onCreateView(
        ...
        dataBinding = BottomSheetAlertSoundDetailBinding.inflate(inflater, container, false)
    ...
    companion object {
        const val TAG = "EnableOneMethodBottomSheet"
        fun newInstance(title : String, content : String, txtOk : String): EnableOneMethodBottomSheet {
            val args = Bundle()
            args.putString("title", title)
            args.putString("content", content)
            args.putString("txtOk", txtOk)
            val fragment = EnableOneMethodBottomSheet()
